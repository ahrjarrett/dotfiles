...
values."
  (setq-default
   ...
   '((auto-completion :disabled-for org)
     ...
     markdown
     (org :variables
          ;;org-projectile-file "~/Desktop/stuff/org/TODOs.org"
...
values."
  ...
  (setq-default
   ...
   dotspacemacs-startup-banner nil ;; 000
   ;; Options: `recents' `bookmarks' `projects' `agenda' `todos'."
   ...
   dotspacemacs-themes '(hc-zenburn leuven material spacemarks-dark)
...
you should place your code here."
  ...
  (setq org-capture-templates
        ...
        ;; type
        ;; capture template
        '(("t" "Todo Item" entry (file+headline todos-file "Todos:")
           "* TODO %?\n\s\s%T" :prepend t)

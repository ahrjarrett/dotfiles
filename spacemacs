...
you should place your code here."
  ...
  (setq org-capture-templates
        ...
        '(("t"
           "Todo Item"
           entry
           (file+headline todos-file "TODOS:")
           "* TODO %?\n\s\s%T" :prepend t)
